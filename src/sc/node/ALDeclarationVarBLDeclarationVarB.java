...
public final class ALDeclarationVarBLDeclarationVarB extends PLDeclarationVarB
{
    private TVrg _vrg_;
    private PVarDeclaration _varDeclaration_;
    private PLDeclarationVarB _lDeclarationVarB_;

    public ALDeclarationVarBLDeclarationVarB()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALDeclarationVarBLDeclarationVarB(
    ...
    {
        ((Analysis) sw).caseALDeclarationVarBLDeclarationVarB(this);
    }
